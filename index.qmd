...
Seven parts, twenty-five chapters, five appendices:
...
- **Part VII, Inside the Engines** is the long look back. Five of the
  ...
  shade, and Lore's story systems. Every one of these chapters vendors
  the real, shipped engine into its runnable example, so what you read
  is what runs — and the five together are a study in the one decision
  that matters most: deciding what your engine is *about*.
