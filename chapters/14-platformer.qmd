...
knowing about: `Phys.moveAssist` (`tiles/core/tphys.lua:63`), the
...
- This physics is not a toy: it *is* `tiles/core/tphys.lua`, four
  shipped games deep. @sec-tiles reads it in full, including the
  variants those games needed — a walkable bomb, a falling boulder.
